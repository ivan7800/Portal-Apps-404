      ...
      '<div class="os-shell">' +
        ...
        '<div class="os-main">' +
          ...
          '<main class="workspace" id="main-content">' +
            ...
            '<footer class="footer"><div><img src="assets/logo.webp" alt="" width="36" height="36"><span><strong>Universo 404 OS</strong><small>I. Roig · v34 Ultimate Motion</small></span></div><p>' + APPS.length + ' apps · local-first · sin tracking · GitHub Pages</p><a href="#top">Volver al núcleo ↑</a></footer>' +
          '</main>' +
          mobileNavHTML() +
        '</div>' +
      '</div>' +
