...
Portal estático y PWA instalable que reúne **89 proyectos web** de I. Roig. Está preparado para GitHub Pages, funciona sin backend, no incorpora analítica ni dependencias externas y mantiene todo el catálogo en el navegador.

## Características

- Catálogo de 89 aplicaciones con búsqueda por nombre, categoría, descripción, saga, intención o tecnología.
- Filtros por tecnología y por siete sagas temáticas.
- Centro de mando Universo 404 OS con 89 aplicaciones, acceso por intención y mapa orbital de los siete mundos.
...
assets/
  ...
  data.js                  Catálogo de 89 aplicaciones
...
- Total verificado: **89 aplicaciones**.
...
- Catálogo y métricas siguen calculándose desde las 89 apps reales.

## Actualización v31 — Signature Edition

- Mantiene las 89 aplicaciones y la arquitectura visual elegida de Universo 404 OS.
...
- Caché PWA actualizada a `portal-apps-404-v31-signature`.
