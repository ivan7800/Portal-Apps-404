...
Portal estático y PWA instalable que reúne **73 proyectos web** de I. Roig. Está preparado para GitHub Pages, funciona sin backend, no incorpora analítica ni dependencias externas y mantiene todo el catálogo en el navegador.

## Características

- Catálogo de 73 aplicaciones con búsqueda por nombre, categoría, descripción, saga o tecnología.
...
assets/
  ...
  data.js                  Catálogo de 73 aplicaciones
