...
async function createHarness(scope = 'https://example.test/') {
  ...
  const caches = {
    ...
    keys: async () => ['another-app-v1', 'portal-apps-404-v38-1-release-audit', 'portal-apps-404-v41-17-direct-filter-toggle'],
...
test('instala el shell y activa solo su familia de cachés', async () => {
  ...
  await task;
  assert.deepEqual(harness.calls.deleted, ['portal-apps-404-v38-1-release-audit']);
