...
async function createHarness(scope = 'https://example.test/') {
  ...
  const caches = {
    ...
    keys: async () => ['another-app-v1', 'portal-apps-404-v38-1-release-audit', 'portal-apps-404-v41-11-clean-catalog', 'portal-apps-404-v41-21-stable-catalog-restore', 'portal-apps-404-v41-22-quinqui-404', 'portal-apps-404-v41-23-night-shift-404'],
